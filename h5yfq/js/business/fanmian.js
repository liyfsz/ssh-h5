$(".uploadPic5").change(function(obj) {
    var objUrl;
    objUrl = getObjectURL5(this.files[0]);
    $(this).siblings("span").css("background-image", "url(" + objUrl + ")").find("img").attr("src","");
    _create5(objUrl,function(){},$(this).prop("id"));
    
  });
   function getObjectURL5(file) {
    var url = null;
...
/*创建图片*/
  function _create5(blob,callback,obj) {
    var img = new Image();
    img.src = blob;
