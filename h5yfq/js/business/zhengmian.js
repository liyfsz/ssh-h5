$(".uploadPic4").change(function(obj) {
    var objUrl;
    objUrl = getObjectURL4(this.files[0]);
    $(this).siblings("span").css("background-image", "url(" + objUrl + ")").find("img").attr("src","");
    _create4(objUrl,function(){},$(this).prop("id"));
...
/*创建图片*/
  function _create4(blob,callback,obj) {
    var img = new Image();
    img.src = blob;
