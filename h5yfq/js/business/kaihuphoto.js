$(".uploadPic6").change(function(obj) {
    var objUrl;
    objUrl = getObjectURL3(this.files[0]);
    $(this).siblings("span").css("background-image", "url(" + objUrl + ")").find("img").attr("src","");
    _create3(objUrl,function(){},$(this).prop("id"));
...
/*创建图片*/
  function _create3(blob,callback,obj) {
    var img = new Image();
    img.src = blob;
